...
CREATE TABLE public.slekret_users (
    ...
    last_posted_on date,
    require_activation boolean DEFAULT false NOT NULL,
...
--
-- Name: slekret_users_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.slekret_users_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.slekret_users_id_seq OWNER TO postgres;

--
-- Name: slekret_users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.slekret_users_id_seq OWNED BY public.slekret_users.id;
...
--
-- Name: slekret_users id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.slekret_users ALTER COLUMN id SET DEFAULT nextval('public.slekret_users_id_seq'::regclass);
...
9040d374-d75f-4cf6-8c6b-7d9f0eeb70b2	2021-01-08 06:43:29.637737+00	{"metadata":false,"remote_schemas":[]}
\.
...
942dbfc5-cac8-454b-85f9-00276a02784b	40	2021-01-08 02:50:19.613897+00	{}	{"console_notifications": {"admin": {"date": "2021-01-08T06:05:37.845Z", "read": "default", "showBadge": false}}, "telemetryNotificationShown": true}
\.
...
COPY public.slekret_users (id, password, last_login, username, email, avatar_src, created_at, following, followers, last_posted_on, require_activation, is_hiding_present, is_superuser) FROM stdin;
\.
...
--
-- Name: slekret_users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.slekret_users_id_seq', 1, false);
