...
--
-- Name: blog_article_comment_likes; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.blog_article_comment_likes (
...
ALTER TABLE public.blog_article_comment_likes OWNER TO postgres;

--
-- Name: blog_article_comments; Type: TABLE; Schema: public; Owner: postgres
--
...
--
-- Name: blog_comment_comment_likes; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.blog_comment_comment_likes (
    blog_comment_comment_id uuid NOT NULL,
    user_id uuid NOT NULL,
    is_liked boolean DEFAULT false NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.blog_comment_comment_likes OWNER TO postgres;

--
-- Name: blog_comment_comments; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.blog_reading_list_entries OWNER TO postgres;

--
-- Name: forum_answer_replies; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.forum_answer_replies (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
...
CREATE TABLE public.forum_answer_reply_likes (
    forum_answer_reply_id uuid NOT NULL,
    user_id uuid NOT NULL,
    is_liked boolean DEFAULT false NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL
...
ALTER TABLE public.forum_answer_reply_likes OWNER TO postgres;

--
-- Name: forum_question_answer_votes; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.forum_question_answer_votes (
    forum_question_answer_id uuid NOT NULL,
    user_id uuid NOT NULL,
...
CREATE TABLE public.forum_question_answers (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
...
CREATE TABLE public.forum_reading_list_entries (
    forum_question_id uuid NOT NULL,
    user_reading_list_id uuid NOT NULL
);


ALTER TABLE public.forum_reading_list_entries OWNER TO postgres;
...
--
-- Name: TABLE slekret_user_friendships; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE public.slekret_user_friendships IS 'status [0-3] 0: pending, 1: accepted, 2: declined, 3: block';


--
-- Name: slekret_user_reading_lists; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.slekret_user_reading_lists (
    id uuid DEFAULT public.gen_random_uuid() NOT NULL,
...
--
-- Data for Name: blog_article_comment_likes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.blog_article_comment_likes (user_id, blog_article_comment_id, is_liked, updated_at, created_at) FROM stdin;
\.
...
COPY public.blog_article_likes (user_id, blog_article_id, is_liked, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: blog_comment_comment_likes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.blog_comment_comment_likes (blog_comment_comment_id, user_id, is_liked, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: forum_answer_reply_likes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.forum_answer_reply_likes (forum_answer_reply_id, user_id, is_liked, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: forum_question_answer_votes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.forum_question_answer_votes (forum_question_answer_id, user_id, vote, created_at, updated_at) FROM stdin;
\.
...
--
-- Data for Name: forum_reading_list_entries; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.forum_reading_list_entries (forum_question_id, user_reading_list_id) FROM stdin;
\.
...
COPY public.slekret_user_friendships (user_id_one, user_id_two, status, last_action_user_id, created_at, updated_at) FROM stdin;
\.


--
-- Data for Name: slekret_user_reading_lists; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.slekret_user_reading_lists (id, rl_title, rl_description, rl_cover, user_id, created_at, updated_at) FROM stdin;
\.
...
--
-- Name: blog_article_comment_likes blog_article_comment_likes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_article_comment_likes
    ADD CONSTRAINT blog_article_comment_likes_pkey PRIMARY KEY (user_id, blog_article_comment_id);


--
-- Name: blog_article_comments blog_article_comments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_article_comments
    ADD CONSTRAINT blog_article_comments_pkey PRIMARY KEY (id);
...
--
-- Name: blog_comment_comment_likes blog_comment_comment_likes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_comment_comment_likes
    ADD CONSTRAINT blog_comment_comment_likes_pkey PRIMARY KEY (blog_comment_comment_id, user_id);


--
-- Name: blog_comment_comments blog_comment_comments_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_comment_comments
    ADD CONSTRAINT blog_comment_comments_pkey PRIMARY KEY (id);


--
-- Name: blog_reading_list_entries blog_reading_list_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: forum_answer_replies forum_answer_replies_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_answer_replies
    ADD CONSTRAINT forum_answer_replies_pkey PRIMARY KEY (id);


--
-- Name: forum_answer_reply_likes forum_answer_reply_likes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: forum_question_answer_votes forum_question_answer_votes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: forum_question_answers forum_question_answers_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_question_answers
    ADD CONSTRAINT forum_question_answers_pkey PRIMARY KEY (id);


--
-- Name: forum_question_votes forum_question_votes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_question_votes
    ADD CONSTRAINT forum_question_votes_pkey PRIMARY KEY (forum_question_id, user_id);
...
--
-- Name: forum_reading_list_entries forum_reading_list_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_reading_list_entries
    ADD CONSTRAINT forum_reading_list_entries_pkey PRIMARY KEY (forum_question_id, user_reading_list_id);
...
--
-- Name: slekret_user_reading_lists slekret_user_reading_lists_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.slekret_user_reading_lists
    ADD CONSTRAINT slekret_user_reading_lists_pkey PRIMARY KEY (id);
...
--
-- Name: blog_article_comment_likes set_public_blog_article_comment_likes_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_blog_article_comment_likes_updated_at BEFORE UPDATE ON public.blog_article_comment_likes FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_blog_article_comment_likes_updated_at ON blog_article_comment_likes; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_blog_article_comment_likes_updated_at ON public.blog_article_comment_likes IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: blog_article_comments set_public_blog_article_comments_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_blog_article_comments_updated_at BEFORE UPDATE ON public.blog_article_comments FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_blog_article_comments_updated_at ON blog_article_comments; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_blog_article_comments_updated_at ON public.blog_article_comments IS 'trigger to set value of column "updated_at" to current timestamp on row update';
...
--
-- Name: blog_comment_comment_likes set_public_blog_comment_comment_likes_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_blog_comment_comment_likes_updated_at BEFORE UPDATE ON public.blog_comment_comment_likes FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_blog_comment_comment_likes_updated_at ON blog_comment_comment_likes; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_blog_comment_comment_likes_updated_at ON public.blog_comment_comment_likes IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: blog_comment_comments set_public_blog_comment_comments_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_blog_comment_comments_updated_at BEFORE UPDATE ON public.blog_comment_comments FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_blog_comment_comments_updated_at ON blog_comment_comments; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_blog_comment_comments_updated_at ON public.blog_comment_comments IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: blog_reading_list_entries set_public_blog_reading_list_entries_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_blog_reading_list_entries_updated_at BEFORE UPDATE ON public.blog_reading_list_entries FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_blog_reading_list_entries_updated_at ON blog_reading_list_entries; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_blog_reading_list_entries_updated_at ON public.blog_reading_list_entries IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: forum_answer_replies set_public_forum_answer_replies_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_forum_answer_replies_updated_at BEFORE UPDATE ON public.forum_answer_replies FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_forum_answer_replies_updated_at ON forum_answer_replies; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_forum_answer_replies_updated_at ON public.forum_answer_replies IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: forum_answer_reply_likes set_public_forum_answer_reply_likes_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_forum_answer_reply_likes_updated_at BEFORE UPDATE ON public.forum_answer_reply_likes FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_forum_answer_reply_likes_updated_at ON forum_answer_reply_likes; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_forum_answer_reply_likes_updated_at ON public.forum_answer_reply_likes IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: forum_question_answer_votes set_public_forum_question_answer_votes_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_forum_question_answer_votes_updated_at BEFORE UPDATE ON public.forum_question_answer_votes FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_forum_question_answer_votes_updated_at ON forum_question_answer_votes; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_forum_question_answer_votes_updated_at ON public.forum_question_answer_votes IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: forum_question_answers set_public_forum_question_answers_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_forum_question_answers_updated_at BEFORE UPDATE ON public.forum_question_answers FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_forum_question_answers_updated_at ON forum_question_answers; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_forum_question_answers_updated_at ON public.forum_question_answers IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: forum_question_votes set_public_forum_question_votes_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_forum_question_votes_updated_at BEFORE UPDATE ON public.forum_question_votes FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_forum_question_votes_updated_at ON forum_question_votes; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_forum_question_votes_updated_at ON public.forum_question_votes IS 'trigger to set value of column "updated_at" to current timestamp on row update';
...
--
-- Name: slekret_user_friendships set_public_slekret_user_friendships_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_slekret_user_friendships_updated_at BEFORE UPDATE ON public.slekret_user_friendships FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_slekret_user_friendships_updated_at ON slekret_user_friendships; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_slekret_user_friendships_updated_at ON public.slekret_user_friendships IS 'trigger to set value of column "updated_at" to current timestamp on row update';


--
-- Name: slekret_user_reading_lists set_public_slekret_user_reading_lists_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_public_slekret_user_reading_lists_updated_at BEFORE UPDATE ON public.slekret_user_reading_lists FOR EACH ROW EXECUTE FUNCTION public.set_current_timestamp_updated_at();


--
-- Name: TRIGGER set_public_slekret_user_reading_lists_updated_at ON slekret_user_reading_lists; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TRIGGER set_public_slekret_user_reading_lists_updated_at ON public.slekret_user_reading_lists IS 'trigger to set value of column "updated_at" to current timestamp on row update';
...
--
-- Name: blog_article_comment_likes blog_article_comment_likes_blog_article_comment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_article_comment_likes
    ADD CONSTRAINT blog_article_comment_likes_blog_article_comment_id_fkey FOREIGN KEY (blog_article_comment_id) REFERENCES public.blog_article_comments(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: blog_article_comment_likes blog_article_comment_likes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_article_comment_likes
    ADD CONSTRAINT blog_article_comment_likes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: blog_article_comments blog_article_comments_blog_article_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_article_comments
    ADD CONSTRAINT blog_article_comments_blog_article_id_fkey FOREIGN KEY (blog_article_id) REFERENCES public.blog_articles(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: blog_article_comments blog_article_comments_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_article_comments
    ADD CONSTRAINT blog_article_comments_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: blog_comment_comment_likes blog_comment_comment_likes_blog_comment_comment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_comment_comment_likes
    ADD CONSTRAINT blog_comment_comment_likes_blog_comment_comment_id_fkey FOREIGN KEY (blog_comment_comment_id) REFERENCES public.blog_comment_comments(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: blog_comment_comment_likes blog_comment_comment_likes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_comment_comment_likes
    ADD CONSTRAINT blog_comment_comment_likes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: blog_comment_comments blog_comment_comments_replying_to_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_comment_comments
    ADD CONSTRAINT blog_comment_comments_replying_to_user_id_fkey FOREIGN KEY (replying_to_user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: blog_comment_comments blog_comment_comments_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_comment_comments
    ADD CONSTRAINT blog_comment_comments_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: blog_reading_list_entries blog_reading_list_entries_blog_article_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_reading_list_entries
    ADD CONSTRAINT blog_reading_list_entries_blog_article_id_fkey FOREIGN KEY (blog_article_id) REFERENCES public.blog_articles(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: blog_reading_list_entries blog_reading_list_entries_user_reading_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.blog_reading_list_entries
    ADD CONSTRAINT blog_reading_list_entries_user_reading_list_id_fkey FOREIGN KEY (user_reading_list_id) REFERENCES public.slekret_user_reading_lists(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_answer_replies forum_answer_replies_forum_question_answer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_answer_replies
    ADD CONSTRAINT forum_answer_replies_forum_question_answer_id_fkey FOREIGN KEY (forum_question_answer_id) REFERENCES public.forum_question_answers(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: forum_answer_replies forum_answer_replies_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_answer_replies
    ADD CONSTRAINT forum_answer_replies_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_answer_reply_likes forum_answer_reply_likes_forum_answer_reply_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_answer_reply_likes
    ADD CONSTRAINT forum_answer_reply_likes_forum_answer_reply_id_fkey FOREIGN KEY (forum_answer_reply_id) REFERENCES public.forum_answer_replies(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_answer_reply_likes forum_answer_reply_likes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_answer_reply_likes
    ADD CONSTRAINT forum_answer_reply_likes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_question_answer_votes forum_question_answer_votes_forum_question_answer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_question_answer_votes
    ADD CONSTRAINT forum_question_answer_votes_forum_question_answer_id_fkey FOREIGN KEY (forum_question_answer_id) REFERENCES public.forum_question_answers(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_question_answer_votes forum_question_answer_votes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_question_answer_votes
    ADD CONSTRAINT forum_question_answer_votes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_question_answers forum_question_answers_forum_question_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_question_answers
    ADD CONSTRAINT forum_question_answers_forum_question_id_fkey FOREIGN KEY (forum_question_id) REFERENCES public.forum_questions(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_question_answers forum_question_answers_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_question_answers
    ADD CONSTRAINT forum_question_answers_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_question_votes forum_question_votes_forum_question_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_question_votes
    ADD CONSTRAINT forum_question_votes_forum_question_id_fkey FOREIGN KEY (forum_question_id) REFERENCES public.forum_questions(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_question_votes forum_question_votes_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_question_votes
    ADD CONSTRAINT forum_question_votes_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: forum_reading_list_entries forum_reading_list_entries_forum_question_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_reading_list_entries
    ADD CONSTRAINT forum_reading_list_entries_forum_question_id_fkey FOREIGN KEY (forum_question_id) REFERENCES public.forum_questions(id) ON UPDATE RESTRICT ON DELETE RESTRICT;


--
-- Name: forum_reading_list_entries forum_reading_list_entries_user_reading_list_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.forum_reading_list_entries
    ADD CONSTRAINT forum_reading_list_entries_user_reading_list_id_fkey FOREIGN KEY (user_reading_list_id) REFERENCES public.slekret_user_reading_lists(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
--
-- Name: slekret_user_reading_lists slekret_user_reading_lists_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.slekret_user_reading_lists
    ADD CONSTRAINT slekret_user_reading_lists_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.slekret_users(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
