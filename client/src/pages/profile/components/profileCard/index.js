        ...
        >
          <div className="md:w-1/3 w-full">
            <img
              ...
              src="https://scontent.fpnh10-1.fna.fbcdn.net/v/t1.0-9/90355465_2831326093650021_3661684079125856256_o.jpg?_nc_cat=103&ccb=2&_nc_sid=09cbfe&_nc_ohc=rshhzKfx6dIAX-oqhGL&_nc_ht=scontent.fpnh10-1.fna&oh=73d960fec311e9f7533051270f61dfcf&oe=601E0B1D"
              alt=""
            />
            <Link
              to={`/user/${id}/setting`}
          ...
          <div className="md:w-2/3 w-full px-3 flex flex-row flex-wrap">
            <div className="w-full text-right text-gray-700 font-semibold relative pt-3 md:pt-0">
              ...
              <p className="text-normal text-gray-300 text-justify leading-relaxed">
                ...
                Curabitur pretium massa ac lectus mattis eleifend nec vitae
                mauris. Curabitur tristique, ipsum vitae aliquam pretium, magna
                metus volutpat urna, nec venenatis nisi nisl ut nulla. Nulla
                sodales vehicula dictum. Quisque eu mauris laoreet lacus congue
                pharetra. Donec eu urna sagittis, lacinia odio in, sagittis
                tellus.
              </p>
