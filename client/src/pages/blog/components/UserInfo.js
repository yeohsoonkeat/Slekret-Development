...
const UserInfo = ({ user }) => {
	...
	const is_in_reading_list = blog_reading_list_entries
		? blog_reading_list_entries.length > 0
		: false;
	return (
		<div className="mt-2 border-t pt-2 flex justify-between items-center">
			...
			<div className="flex">
				...
				<div
					className={`p-2 border rounded-full text-gray-600 hover:bg-gray-200 ${
						is_in_reading_list ? ' text-yellow-400' : ''
					}`}
				>
