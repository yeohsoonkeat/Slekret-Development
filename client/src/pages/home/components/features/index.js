  ...
  return (
      ...
      <div className="container max-w-5xl mx-auto m-8 ">
        ...
        <div className="w-full mb-4 ">
          <div className="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t bg-purple-900">
