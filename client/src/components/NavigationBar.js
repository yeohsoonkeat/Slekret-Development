...
export default function NavigationBar() {
	...
	return (
		<nav className="bg-gray-800 w-full">
			{/* <MobileView openNavBar={openNavBar} setOpenNavBar={setOpenNavBar} /> */}
			<div className="max-w-8xl mx-auto px-6 py-5  flex items-center justify-between">
				...
				<Link to="/auth/signin" className="flex text-white items-center">
...
const MobileView = ({ setOpenNavBar, openNavBar }) => {
	return (
		<>
			<div className="max-w-8xl mx-auto px-6 py-5  flex items-center justify-between ">
				<button
				...
				<Link
					to={routes.home}
					className="text-white font-semibold hover:tracking-wider transition-all"
				>
					Slekret
				</Link>
